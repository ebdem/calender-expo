...
import { DatePickerProps } from "../types/ICalenderProps";
...
const DateRangePicker = ({
  ...
  const selected = useCallback((_date: { isBetween: (arg0: any, arg1: any, arg2: null, arg3: string) => any; isSame: (arg0: any, arg1: string) => any; }, _startDate: any, _endDate: any, __date: any) => {
    return (
      (_startDate &&
        _endDate &&
  ...
  const disabled = useCallback((_date: { isBefore: (arg0: any, arg1: string) => any; isAfter: (arg0: any, arg1: string) => any; }, _minDate: any, _maxDate: any) => {
    return (
  ...
  useEffect(() => {
    ...
    function populate() {
      ...
      setDayHeaders(_dayHeaders as any);
      setWeeks(_weeks as any);
    }
    populate();
  }, [
    startDate,
